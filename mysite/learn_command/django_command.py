#!/usr/bin/env python
# -*- coding:utf-8 -*-
# @Time: 2019/12/9 09:48

# -*- encoding: utf-8 -*-
# Django 基本命令
# 1 新建一个 django project
# django-admin.py startproject project_name          # 新建一个项目
...
# （当然也可以kill掉占用端口的进程，具体后面有讲，此处想知道的同学可查下lsof命令用法）

# 启动服务 监听机器所有可用 ip （电脑可能有多个内网ip或多个外网ip）
...
# 修改 用户密码可以用：
# python manage.py changepassword ghou           # donga123
